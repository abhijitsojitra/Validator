...
public class Form_validation_utils {
    ...
    public Form_validation_utils() {
    }

    public Form_validation_utils(Context c) {
        this._c = c;
...
//                            Class cls = this.getClass();
                            Class cls = Class.forName("com.emxcel.validator.Form_validation_utils");
